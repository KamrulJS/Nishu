...
function Experience() {
  const { hero, experience } = portfolioData;

  return (
    <section className="resume section-padding" id="experience">
      <div className="container">
        <div className="sec-head mb-80 d-flex align-items-center flex-wrap">
          <div>
          ...
          <div className="ml-auto mt-20 mt-md-0">
            <a
                  ...
                  <div className="col-lg-9">
                    <div className="cont">
                      <h4 className="fw-600 mb-5">
                        {xp.companyUrl ? (
                          <a href={xp.companyUrl} target="_blank" rel="noopener noreferrer" className="main-color hover-underline">
                            {xp.company} ↗
                          </a>
                        ) : (
                          xp.company
